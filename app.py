...
title_main = st.title("Ranking Simulation")
...
if st.session_state['launch_simulation']==True:
    ...
    if len(st.session_state['df_tournament_simulated'])==0:
        ...
        figure_ranking_chart_simulated = get_viz_ranking_simulated(df_ranking_over_weeks_simulated,figure_ranking_chart_simulated)
